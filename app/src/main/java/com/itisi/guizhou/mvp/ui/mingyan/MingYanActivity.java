 ...
 */
@UseRxBus
public class MingYanActivity extends RootActivity<MingYanPresenter>
        implements MingYanContract.View
    ...
    protected int getLayoutId() {
        return R.layout.activity_ming_yan;
    }
