...
public class ItToolPresenter extends RxPresenter<ItToolContract.View> implements ItToolContract.Presenter {

    private DataManager mDataManager;

    @Inject
    public ItToolPresenter(DataManager dataManager) {
