 ...
 */
@UseRxBus
public class RecuitDetailActivity extends RootActivity<RecuitDetailPresenter>
    ...
    protected int getLayoutId() {
        return R.layout.activity_recuit_detail;
...
//        setToolbarBackground(getResources().getColor(R.color.colorTransparent));
        ...
        setToolbarMoreClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityUtil.getInstance().openActivity(RecuitDetailActivity.this, ChatActivity.class);
            }
        });
    }

    private void initHeaderView() {
        mHeaderView = View.inflate(this, R.layout.partial_header_recuit, null);
    }
