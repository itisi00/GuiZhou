package com.itisi.guizhou.mvp.ui.rental;
...
@UseRxBus
public class RentalActivity extends RootActivity<RentalPresenter>
        implements RentalContract.View
    ...
    protected void initEventAndData() {
        ...
        setToolbarMoreClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityUtil.getInstance().openActivity(RentalActivity.this, RentalAddActivity.class);
