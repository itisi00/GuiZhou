...
public class FadebackPresenter extends RxPresenter<FadebackContract.View> implements FadebackContract.Presenter {

    private DataManager mDataManager;

    @Inject
    public FadebackPresenter(DataManager dataManager) {
