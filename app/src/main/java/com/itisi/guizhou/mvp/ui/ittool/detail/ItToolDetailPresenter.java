 ...
 * 创建人:itisi
 * 邮  箱:itisivip@qq.com
 * 创建时间:2017/7/26 15:06
 * 修改人:itisi
 * 修改时间: 2017/7/26 15:06
 * 修改内容:itisi
 * *********************
 */

public class ItToolDetailPresenter extends RxPresenter<ItToolDetailContract.View> implements ItToolDetailContract.Presenter {

    private DataManager mDataManager;

    @Inject
    public ItToolDetailPresenter(DataManager dataManager) {
