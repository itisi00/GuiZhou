...
@UseRxBus
public class UniversityStyleActivity extends RootActivity<UniversityStylePresenter>
    ...
    protected int getLayoutId() {
        return R.layout.activity_university_style;
    }
    ...
    protected void initEventAndData() {
        ...
        setToolbarMoreClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityUtil.getInstance().openActivity(UniversityStyleActivity.this, UniversityStyleAddActivity.class);
            }
        });
    }
