...
public class WebsitPresenter extends RxPresenter<WebsitContract.View> implements WebsitContract.Presenter {

    private DataManager mDataManager;

    @Inject
    public WebsitPresenter(DataManager dataManager) {
