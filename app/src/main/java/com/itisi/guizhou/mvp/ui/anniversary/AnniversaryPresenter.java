...
public class AnniversaryPresenter extends RxPresenter<AnniversaryContract.View> implements AnniversaryContract.Presenter {

    private DataManager mDataManager;

    @Inject
    public AnniversaryPresenter(DataManager dataManager) {
