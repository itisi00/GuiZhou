package com.itisi.guizhou.mvp.ui.mingyan;
...
public class MingYanPresenter extends RxPresenter<MingYanContract.View> implements MingYanContract.Presenter {

    private DataManager mDataManager;

    @Inject
    public MingYanPresenter(DataManager dataManager) {
