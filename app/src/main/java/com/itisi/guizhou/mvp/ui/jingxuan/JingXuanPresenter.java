...
public class JingXuanPresenter extends RxPresenter<JingXuanContract.View> implements JingXuanContract.Presenter {

    private DataManager mDataManager;

    @Inject
    public JingXuanPresenter(DataManager dataManager) {
