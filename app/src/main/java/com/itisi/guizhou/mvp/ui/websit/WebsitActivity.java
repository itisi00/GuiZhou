package com.itisi.guizhou.mvp.ui.websit;
...
@UseRxBus
public class WebsitActivity extends RootActivity<WebsitPresenter>
        implements WebsitContract.View
    ...
    protected int getLayoutId() {
        return R.layout.activity_websit;
    }
    ...
    protected void initEventAndData() {
        ...
        setToolbarMoreClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityUtil.getInstance().openActivity(WebsitActivity.this, WebsitAddActivity.class);
    ...
    private void initAdapter() {
        ...
        mAdapter = new WebsitAdapter(R.layout.item_websit);
...
//            mAdapter.loadMoreEnd(true);//true is gone,false is visible,加载完成 不显示底部提示语
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ActivityUtil.getInstance().openActivity(this, WebsitDetailActivity.class);
    }
