package com.itisi.guizhou.mvp.ui.ittool;
...
import com.itisi.guizhou.mvp.adapter.ItToolAdapter;
...
@UseRxBus
public class ItToolActivity extends RootActivity<ItToolPresenter>
        implements ItToolContract.View
    ...
    protected int getLayoutId() {
        return R.layout.activity_it_tool;
    }
    ...
    protected void initEventAndData() {
        ...
        setToolbarMoreClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityUtil.getInstance().openActivity(ItToolActivity.this, ItToolAddActivity.class);
    ...
    private void initAdapter() {
        ...
        mAdapter = new ItToolAdapter(R.layout.item_ittool);
...
//            mAdapter.loadMoreEnd(true);//true is gone,false is visible,加载完成 不显示底部提示语
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ActivityUtil.getInstance().openActivity(this, ItToolDetailActivity.class);
    }
