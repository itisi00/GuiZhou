...
import com.itisi.guizhou.adapter.TeChanAdapter;
...
@UseRxBus
public class TeChanActivity extends RootActivity<TeChanPresenter>
        implements TeChanContract.View
    ...
    protected int getLayoutId() {
        return R.layout.activity_te_chan;
    }
    ...
    private void initAdapter() {
        ...
        mAdapter = new TeChanAdapter(R.layout.item_techan);
