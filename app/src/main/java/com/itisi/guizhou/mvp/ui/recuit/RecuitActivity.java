...
import com.itisi.guizhou.mvp.ui.adapter.RecuitAdapter;
...
public class RecuitActivity extends RootActivity<RecuitPresenter>
    ...
    protected int getLayoutId() {
        return R.layout.activity_recuit;
    }
...
//        layoutManager.setGapStrategy(StaggeredGridLayoutManager.GAP_HANDLING_NONE);
        ...
        mAdapter=new RecuitAdapter(R.layout.item_recuit);
...
//        });
    ...
    public void loadSuccess(List<MeiZiBean> beanList) {
        if (isRefreshing){
            ...
            mPullToRefreshView.setRefreshing(false);//结束下拉刷新
        }else{
